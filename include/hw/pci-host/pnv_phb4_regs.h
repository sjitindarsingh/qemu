...
/* This is the "stack" offset, it's the offset from a given range base to
 * the first "per-stack" registers and also the stride between stacks,
 * thus for PEC2, the global registers are at offset 0, the PHB3 registers
 * at offset 0x40, the PHB4 at offset 0x80 etc....
 *
...
/* XSCOM PCI "pass-through" windo to PHB SCOM */
#define PEC_PCI_SCOM_STK0               0x100
#define PEC_PCI_SCOM_STK1               0x140
#define PEC_PCI_SCOM_STK2               0x180
